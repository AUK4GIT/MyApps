...
//    frameError.origin.x = CGRectGetMaxX(self.bounds) - CGRectGetWidth(self.labelErrorPlaceholder.frame);
    ...
    frameError.origin.y = self.bounds.size.height+30;
    self.labelErrorPlaceholder.frame = frameError;
    _labelErrorPlaceholder.alpha = 0.0;
}
...
//        frame.origin.y -= (frame.size.height);
        frame.origin.y = self.bounds.size.height+30;
        ...
        [UIView animateWithDuration:0.2 animations:^{
            ...
            _labelErrorPlaceholder.alpha = 1.0;
        }];
...
-(void)hideErrorPlaceHolder{
    ...
    labelErrorFrame.origin.y = self.bounds.size.height+30;
